        ...
        <footer className={`py-8 mt-auto border-t ${isDarkMode ? 'bg-gray-900 border-gray-800 text-gray-400' : 'bg-gray-50 border-gray-200 text-gray-600'}`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
                    ...
                    {/* Contact */}
                    <div className="flex items-center gap-2 text-sm bg-indigo-50 dark:bg-gray-800 px-4 py-2 rounded-full border border-indigo-100 dark:border-gray-700 hover:shadow-sm transition-shadow">
