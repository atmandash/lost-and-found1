...
const Layout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col relative">
            ...
            <main className={`flex-grow mx-auto py-8 ${location.pathname === '/' ? 'pb-20' : 'pb-32 md:pb-8'} flex flex-col w-full max-w-full overflow-x-hidden ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>
                {children}
            </main>
