...
const generateAvatar = (userId, name) => {
    // Original premium avatar styles
...
// Predefined avatar styles for selection (original pack)
const AVATAR_STYLES = [
    'micah',
    'lorelei',
    'notionists'
            ...
            <div className="bg-gradient-to-br from-cyan-500 via-teal-500 to-emerald-500 p-8 rounded-3xl shadow-xl text-white animate-fade-in-scale">
                <div className="flex flex-col md:flex-row items-center text-center md:text-left gap-6">
                    ...
                    <div className="flex-1">
                        ...
                        {/* Phone Number and Verified Badge - Hide for Admins */}
                        {!user.isAdmin && (
                    ...
                    <button
                        ...
                        className="px-6 py-2 bg-white text-teal-600 rounded-lg hover:bg-opacity-90 transition-all font-semibold shadow-lg hover-scale flex-shrink-0"
                    >
                        Logout
                    </button>
                </div>
